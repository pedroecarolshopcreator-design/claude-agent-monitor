 ...
 * 8 distinct poses, each 16x16 pixels rendered via CSS box-shadow.
 *
 * Color key:
...
export const SPRITE_POSES: Record<AgentPose, PixelData> = {
  idle: POSE_IDLE,
  coding: POSE_CODING,
...
export const SPRITE_FRAMES: Record<SpriteFrame, PixelData> = {
  idle: POSE_IDLE,
  working: POSE_CODING,
  shutdown: POSE_IDLE, // shutdown uses idle pose + zzZ overlay
};
