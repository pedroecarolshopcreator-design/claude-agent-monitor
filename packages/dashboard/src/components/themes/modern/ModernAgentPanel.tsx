  ...
  if (agents.length === 0) {
    return (
      <div className="p-4 flex flex-col items-center justify-center h-full text-center">
        ...
        <p className="text-xs text-cam-text-muted">
          Waiting for agents...
        </p>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            <div className={`w-1.5 h-1.5 rounded-full shrink-0 ${getStatusDotColor(agent.status)} ${agent.status === 'active' ? 'animate-pulse-dot' : ''}`} />
