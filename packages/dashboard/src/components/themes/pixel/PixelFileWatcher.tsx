            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLElement).style.background = 'var(--pixel-surface)';
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <span className="pixel-text-xs block truncate" style={{ color: 'var(--pixel-text)' }}>
                    {truncatePath(file.filePath, 30)}
                  </span>
                ...
                <div className="flex items-center gap-1 shrink-0">
                  {file.touchCount > 1 && (
                    <span className="pixel-text-xs px-1" style={{
